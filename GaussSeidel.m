function sol = GaussSeidel(A,b,x0,num_iter); 
%GAUSSSEIDEL menerapkan metode iterasi untuk mencari solusi Ax=b
%	sol = GAUSSSEIDEL(A,b,x0,num_iter) menerima input matriks A, vektor b, vektor
